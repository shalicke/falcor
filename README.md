...
get the app created:
    ...
    $ heroku apps:create falcor
    Creating falcor... done, stack is cedar
    http://falcor.herokuapp.com/ | git@heroku.com:falcor.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://falcor.herokuapp.com deployed to Heroku

    To git@heroku.com:falcor.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://falcor.herokuap.com
    ["Hello" :from Heroku]
